...
@Component
@Slf4j
public class DomainGroupDefaultLdapMapper extends AbstractLdapMapper
    implements DomainGroupLdapMapper {
   ...
   */
  public DomainGroupDefaultLdapMapper(
  ...
  public void map(LdapEntry ldapEntry, DomainGroup domainGroup) {
    ...
    mapSamAccount(ldapEntry, domainGroup);
  ...
  @Override
  public DomainGroupMember mapDomainGroupMember(LdapEntry entry, boolean selected) {
    DomainGroupMember destination = new DomainGroupMember();
    mapSamAccount(entry, destination);
    ...
    destination.setDisplayName(getMemberDisplayName(entry));
